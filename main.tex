...
\begin{figure}[ht!]
\centering
\fbox{\includegraphics[width=0.50\linewidth]{figures/duck.jpg}}
\caption{
Blabla
}
\label{fig:Fig4}
...
\figsupp[Fig4 suppl.]{
qwerty
}{\fbox{\includegraphics[width=0.85\linewidth]{figures/duck.jpg}}}\label{figsupp:f4S1}
\end{figure}
...
qwerty
}{\fbox{\includegraphics[width=0.85\linewidth]{figures/Fig5S1.pdf}}}\label{figsupp:f5S1}
