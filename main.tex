...
Other adapters were tested with similar results (see \FIGSUPP[Fig2]{f2S3}).
}
\label{fig:Fig2}
...
}{\fbox{\includegraphics[width=0.65\linewidth]{figures/Fig2S1.pdf}}}\label{figsupp:f2S1}
...
}{\fbox{\includegraphics[width=0.9\linewidth]{figures/Fig2S3.pdf}}}\label{figsupp:f2S3}
...
\figsupp[Suppl. fig 6.]{
Suppl. figure Caption
}{\fbox{\includegraphics[width=0.5\linewidth]{figures/Fig2S6.pdf}}}\label{figsupp:f2S6}

\figsupp[Suppl. fig 7.]{
Suppl. figure Caption
}{\fbox{\includegraphics[width=0.9\linewidth]{figures/Fig2S7.pdf}}}\label{figsupp:f2S7}

\figsupp[Suppl. fig 8.]{
Suppl. figure Caption
}{\fbox{\includegraphics[width=0.7\linewidth]{figures/Fig2S8.pdf}}}\label{figsupp:f2S8}

\figsupp[Suppl. fig 9.]{
Suppl. figure Caption
}{\fbox{\includegraphics[width=0.7\linewidth]{figures/Fig2S9.pdf}}}\label{figsupp:f2S9}
\end{figure}
